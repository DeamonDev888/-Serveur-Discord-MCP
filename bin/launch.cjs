process.title = "MCP-DISCORD"; // [V16] Window identification
// launch.js — compiled launcher for serveur_discord
...
const PORT       = "3141";
const NAME       = "serveur_discord";
const BUILD_CMD  = "tsc -p tsconfig.build.json";
