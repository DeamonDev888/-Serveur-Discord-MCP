...
client.once('ready', async () => {
  ...
  try {
    ...
    const embed = new EmbedBuilder()
      ...
      .setColor('#5865F2')
      .setImage(
        'https://media.discordapp.net/attachments/1443768838587154563/120000000000000000/banner.png?ex=65a00000&is=65800000&hm=... (placeholder)'
      ) // Placeholder ou on enlève
