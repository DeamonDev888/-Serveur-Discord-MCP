...
export const FileDownloadSchema = z.object({
  ...
  outputDir: z
    ...
    .optional()
    .describe(
      'Dossier de destination LOCAL sur la machine. Le LLM doit choisir intelligemment un dossier selon le contexte (ex: "./evidence" pour des preuves, "./images" pour des images) ou utiliser un chemin absolu. Défaut: "./downloads"'
    ),
  ...
  attachmentIndex: z
    ...
    .optional()
    .default(0)
    .describe("Index de l'attachment à télécharger (défaut: 0)"),
});
...
export function registerFileDownloadTools(server: FastMCP) {
  server.addTool({
    ...
    description:
      'Télécharge un fichier (image, doc, etc.) depuis un message Discord vers le disque local',
